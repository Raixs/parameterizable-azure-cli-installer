...
parser.add_argument('--version', help='Version of Azure CLI to install', required=False)
args = parser.parse_args()

# Use the specified version or an empty string if no version is provided
azure_cli_version = "==" + args.version if args.version else ''
# print the version
print('Installing Azure CLI {}'.format(azure_cli_version))
...
def install_cli(install_dir, tmp_dir):
    ...
    cmd = [path_to_pip, 'install', '--cache-dir', tmp_dir, 'azure-cli'+azure_cli_version]
    exec_command(cmd)
